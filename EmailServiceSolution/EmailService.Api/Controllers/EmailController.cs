using EmailService.Library; // Reference the EmailService class
...
namespace EmailService.Api.Controllers
{
    ...
    {
        private readonly EmailService.Library.EmailService _emailService;

        public EmailController(EmailService.Library.EmailService emailService)
        {
